// src/db/migrate.js
// Execute: node src/db/migrate.js
...
async function migrate() {
  ...
  try {
    ...
    // Cada cliente do SaaS é um "tenant"
    await query(`
    ...
    // ── TABELA: LEAD_ACTIVITIES (histórico) ───────────────────
    await query(`
    ...
    console.log('📌 Tabelas criadas: tenants, users, leads, lead_activities, reminders, message_templates, remarketing_campaigns, refresh_tokens');
    process.exit(0);
  } catch (err) {
